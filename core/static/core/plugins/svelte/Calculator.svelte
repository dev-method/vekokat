...
<input type="number" bind:value={value_1}>

<input type="number" bind:value={value_2}>

<input type="number" bind:value={value_3}>

<h1>VALUE №2: {value_2}</h1>
<h1>VALUE №3: {value_3}</h1>
